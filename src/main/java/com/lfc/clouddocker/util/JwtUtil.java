...
import com.lfc.clouddocker.constant.DataBaseConstant;
import com.lfc.clouddocker.exception.YunException;
...
public class JwtUtil {
	 ...
	 * @throws YunException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws YunException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new YunException("未获取到用户");
		}
		return username;
	}
