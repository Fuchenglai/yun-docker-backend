package com.lfc.clouddocker.websocket;
...
import com.lfc.clouddocker.util.SpringContextUtils;
...
public class WebSocketServer {
    ...
    public void onClose() {
        if (WEB_SOCKET_MAP.containsKey(userId)) {
            ...
            SpringContextUtils.getBean(YunDockerClient.class).closeStatsCmd(userId);
        }
    ...
    public void onMessage(String message, Session session) {
        ...
        if (StringUtils.isNotBlank(message)) {
            try {
                ...
                //执行任务
                SpringContextUtils.getBean(YunDockerClient.class).readCtrStats(ctrId, userId);
