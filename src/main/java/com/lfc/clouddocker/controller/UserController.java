...
public class UserController {
    ...
    public BaseResponse<Integer> getCredit(HttpServletRequest request) {
        User user = userService.getLoginUser(request);
        return ResultUtils.success(user.getBalance());
    }
